...
public class Marriage_Ads_Grid_Adopter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    ArrayList<MarriageAdModel> marriagePostsList;

    private final Marriage_Ads_Grid_Adopter.MyPOstItemClickListener mItemClickListener;
    Context context;

    public Marriage_Ads_Grid_Adopter(ArrayList<MarriageAdModel> marriagePostsList, Context context, Marriage_Ads_Grid_Adopter.MyPOstItemClickListener itemClickListener) {
        this.marriagePostsList = marriagePostsList;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        //Create View Holder
        final Marriage_Ads_Grid_Adopter.MyViewHolder commonViewHolder = new Marriage_Ads_Grid_Adopter.MyViewHolder(view);
        ...
        commonViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mItemClickListener.onItemClicked((MarriageAdModel) marriagePostsList.get(commonViewHolder.getLayoutPosition()));
            }
        });
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        MarriageAdModel commonAdModel = marriagePostsList.get(position);
    ...
    public interface MyPOstItemClickListener {
        void onItemClicked(MarriageAdModel model);
    }
