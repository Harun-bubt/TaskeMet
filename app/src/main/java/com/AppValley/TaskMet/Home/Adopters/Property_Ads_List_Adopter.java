...
public class Property_Ads_List_Adopter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public Property_Ads_List_Adopter(ArrayList<PropertyAdModel> propPostsList, Context context, Property_Ads_List_Adopter.MyPOstItemClickListener itemClickListener) {
