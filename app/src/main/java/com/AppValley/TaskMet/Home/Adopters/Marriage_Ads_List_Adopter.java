...
public class Marriage_Ads_List_Adopter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public Marriage_Ads_List_Adopter(ArrayList<MarriageAdModel> marriagePostsList, Context context, Marriage_Ads_List_Adopter.MyPOstItemClickListener itemClickListener) {
