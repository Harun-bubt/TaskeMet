...
public class Screen6_WaitingPostNow extends Fragment {

    Context context;

    int post_id;
    View view;
    int my_gc_balance, my_rc_balance, post_now_gc, post_now_rc;

    ImageView my_post_image;
    TextView my_post_title, my_post_date, my_post_category, tv_gc_balance, tv_rc_balance, gc_cost, rc_cost;
    ...
    public Screen6_WaitingPostNow(Context context) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_screen6__post_now, container, false);
        ...
        post_now_gc = preferences.getInt(Constants.POST_NOW_COST_RC, 0);
        post_now_rc = preferences.getInt(Constants.POST_NOW_COST_RC, 0);
    ...
    public void onResume() {
        ...
        gc_cost.setText(String.valueOf(post_now_gc) + " " + getString(R.string.gc));
        rc_cost.setText(String.valueOf(post_now_rc) + " " + getString(R.string.rc));
        ...
        btn_gc_premium.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (my_gc_balance > post_now_gc) {

                    new SweetAlertDialog(getContext(), SweetAlertDialog.WARNING_TYPE)
                            .setContentText("On confirmation " + String.valueOf(post_now_gc) + " GC will be deducted from your wallet.")
                                ...
                                public void onClick(SweetAlertDialog sDialog) {
                                    ...
                                    Thread thread = new Thread(new Runnable() {
                                        ...
                                        public void run() {
                                            ...
                                            Call<Status_Response> call = taskMetServer.postNowPaid(post_id, "GC");
                    ...
                    new SweetAlertDialog(getContext(), SweetAlertDialog.ERROR_TYPE)
                            .setContentText("Sorry, you don't have enough GC balance to post this Ad now.")
                            ...
                            .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                                ...
                                public void onClick(SweetAlertDialog sDialog) {
                                    ...
                                    intent.putExtra(Constants.FRAGMENT_NAME, "WalletFragment");
        ...
        btn_rc_premium.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (my_rc_balance > post_now_rc) {

                    new SweetAlertDialog(getContext(), SweetAlertDialog.WARNING_TYPE)
                            .setContentText("On confirmation " + String.valueOf(post_now_rc) + " RC will be deducted from your wallet.")
                            .setConfirmText("Confirm")
                            .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                                @Override
                                public void onClick(SweetAlertDialog sDialog) {
                                    ...
                                    Thread thread = new Thread(new Runnable() {
                                        ...
                                        public void run() {
                                            ...
                                            Call<Status_Response> call = taskMetServer.postNowPaid(post_id, "RC");
                                            call.enqueue(new Callback<Status_Response>() {
                                                @Override
                                                public void onResponse(Call<Status_Response> call, Response<Status_Response> response) {
                                                    if (response.isSuccessful()) {
                    ...
                    new SweetAlertDialog(getContext(), SweetAlertDialog.ERROR_TYPE)
                            .setContentText("Sorry, you don't have enough RC balance to post this Ad now.")
