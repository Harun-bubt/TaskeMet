package com.AppValley.TaskMet.constant;
...
import com.AppValley.TaskMet.GoogleMaps.MyMapActivity;
...
public class PlacePicker {
    ...
    public static class IntentBuilder {
        ...
        public final Intent build(Activity activity) {
            ...
            Intent intent = new Intent((Context)activity, MyMapActivity.class);
